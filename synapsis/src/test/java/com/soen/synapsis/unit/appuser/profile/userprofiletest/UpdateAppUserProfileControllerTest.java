...
class UpdateAppUserProfileControllerTest {
    ...
    void UpdateAppUserInfo() {
        ...
        underTest.updateAppUserProfile(request, mock(MultipartFile.class), mock(MultipartFile.class), mock(MultipartFile.class), mock(MultipartFile.class), mock(BindingResult.class), mock(Model.class));
    ...
    void updateWithErrors() {
        ...
        underTest.updateAppUserProfile(request, mock(MultipartFile.class), mock(MultipartFile.class), mock(MultipartFile.class), mock(MultipartFile.class), bindingResult, model);
        updateAppUserProfileService.updateProfile(request, new AppUser(1L, "joe",
                "12345678", "joe@mail.com", Role.CANDIDATE));
    }
