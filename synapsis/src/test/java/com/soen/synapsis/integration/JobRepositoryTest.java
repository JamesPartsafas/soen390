...
class JobRepositoryTest {
    ...
    void setUp() {
        ...
        Job job1 = new Job(1L, user1, "Software Developer", new AppUser(1L, "joecompany", "1234", "joecompanyunittest@mail.com", Role.COMPANY, AuthProvider.LOCAL), "123 Test Street", "description", JobType.FULLTIME, 1, 1, false, "", true, true);
        Job job2 = new Job(2L, user1, "QA Tester", new AppUser(1L, "joecompany", "1234", "joecompanyunittest@mail.com", Role.COMPANY, AuthProvider.LOCAL), "123 Test Street", "description", JobType.FULLTIME, 1, 1, false, "", true, true);
        Job job3 = new Job(3L, user1, "VBA Tester", new AppUser(1L, "joecompany", "1234", "joecompanyunittest@mail.com", Role.COMPANY, AuthProvider.LOCAL), "123 Test Street", "description", JobType.FULLTIME, 1, 1, true, "https://google.com", true, true);
