...
INSERT INTO job (creator_id, position, company_id, address, description, type, num_available, num_applicants, is_external,
                 external_link, need_resume, need_cover)
VALUES (5, 'VBA Developer', 3, '123 King Street',
       ...
       (5, 'Graphic Artist', 3, '789 Main Street',
        ...
        1, 3, 6, false, '', true, true),
       (5, 'Industrial Engineer', 3, '1011 Popper Street',
       ...
       (5, 'Course Content Writer', 3, '203 Level Street',
        ...
        0, 1, 1, true, 'https://www.google.com/', true, true),
       (5, 'Software Developer', 3, '123 King Street',
