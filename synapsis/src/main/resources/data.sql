...
INSERT INTO job (creator_id, position, company, address, description, type, num_available, num_applicants, is_external, external_link, need_resume, need_cover, need_portfolio)
VALUES (5, 'VBA Developer', 'Macrosoft', '123 King Street', 'We are seeking an experienced VBA developer to join our team. You will be responsible for developing, maintaining, and enhancing Excel-based applications and tools that are used across the company. You will work closely with other developers, business analysts, and end-users to deliver high-quality, user-friendly solutions that meet business needs.', 1, 5, 10, false, '', true, true, true),
       (5, 'Graphic Artist', 'Adibas', '789 Main Street', 'Our company is seeking a creative and skilled graphic artist to join our team. As a graphic artist, you will work closely with our marketing and design teams to create visually appealing and effective graphics for our footwear. Your designs will be a key factor in promoting our brand and driving sales.', 1, 3, 6, false, '', true, true, true),
       (5, 'Industrial Engineer', 'Isded', '1011 Popper Street', 'Isded is seeking an experienced industrial engineer specializing in beverage packaging. You will be responsible for designing and implementing manufacturing processes to improve efficiency, productivity, and product quality. You will work closely with production teams to identify areas of improvement and develop solutions that optimize our manufacturing process.', 1, 1, 2, false, '', true, true, true),
       (5, 'Course Content Writer', 'Craigstutors', '203 Level Street', 'Looking for talented and creative content writers to develop educational materials such as lesson plans, assessments, worksheets, and other learning resources fo students ranging from elementary to K-12. Preferably, you should have at least 3 years of experience.', 1, 1, 1, true, 'https://www.google.com/', true, true, true);
